...
# On Zoho Catalyst, the API Gateway handles CORS natively and adds the headers.
# Adding CORSMiddleware here duplicates headers (e.g. Access-Control-Allow-Credentials: true, true)
