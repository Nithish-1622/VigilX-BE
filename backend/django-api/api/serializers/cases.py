...
class FIRDetailSerializer(serializers.ModelSerializer):
    ...
    entities = ClueEntitySerializer(many=True, read_only=True)
    ...
    class Meta:
        ...
        fields = (
            'id', 'fir_number', 'crime_type', 'incident_date_time', 'reported_date_time',
            'location', 'latitude', 'longitude', 'status', 'description', 'officer_in_charge',
            'officer_in_charge_details', 'victims', 'accused', 'entities', 'created_at', 'updated_at'
        )
        read_only_fields = ('id', 'created_at', 'updated_at', 'officer_in_charge_details', 'victims', 'accused', 'entities')
